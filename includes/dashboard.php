        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row" style="border-radius: 0px;">
                ...
                <div class="card-header px-4" style="background-color: white;">
                    <div class="card-body mb-3 text-primary pt-5" style="text-align: left; font-size: 40px; "><?php echo esc_html( "Welcome to WorkSuite" )?></div>
                    <div class="card-body mb-4" style="font-size: 20px;">
                        <?php echo esc_html( "Congratulations, you have successfully connected to WorkSuite as " )?> 
                        ...
                        <?php echo esc_html( ". Your client can start a chat with" )?> 
                        <span style="font-weight: bold;"> (<?php echo esc_html(get_option('admin_email')) ?>)</span>
                    </div>
                </div>
                <!--/ Congratulation -->
                        ...
                        <div class="border rounded p-3 mt-2">
                            <div class="row gap-4 gap-sm-0">
                                ...
                                <div class="col-12 col-sm-4">
                                    <h4 class="my-2 pt-1"><?php echo esc_html("Total Projects " . $projects_total) ?></h4>
                                    <div class="progress w-75 mb-4" style="height: 4px">
                                        <div class="progress-bar" role="progressbar" style="width: 65%" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <a href="<?php echo admin_url("admin.php?page=worksuite-work"); ?>" class="btn btn-primary">
                                        <?php echo esc_html("Go to work");?>
                                    </a>
                                </div>
                                <!-- /Total Projects-->
                                ...
                                <!-- Total Leads -->
                                <div class="col-12 col-sm-4">
                                    <h4 class="my-2 pt-1"><?php echo esc_html("Total Leads " . $leads_total) ?></h4>
                                    <div class="progress w-75 mb-4" style="height: 4px">
                                        <div class="progress-bar bg-danger" role="progressbar" style="width: 65%" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <a href="<?php echo admin_url("admin.php?page=worksuite-leads"); ?>" class="btn btn-danger"><?php echo esc_html("Open leads");?></a>
                                </div>
                                <!-- /Total Leads -->

                                <!-- Total Clients -->
                                <div class="col-12 col-sm-4">
                                    <h4 class="my-2 pt-1"><?php echo esc_html("Total Clients " . $clients_total) ?></h4>
                                    <div class="progress w-75 mb-4" style="height: 4px">
                                        <div class="progress-bar bg-info" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <a href="<?php echo admin_url("admin.php?page=worksuite-clients"); ?>" class="btn btn-info"><?php echo esc_html("Add clients") ?></a>
                                </div>
                                <!-- /Total Clients -->
                            </div>
                            <div class="row gap-4 gap-sm-0 mt-5 mb-2">
                                <!-- Total Notice -->
                                <div class="col-12 col-sm-4">
                                    <h4 class="my-2 pt-1"><?php echo esc_html("Total Notice " . $notices_total) ?></h4>
                                    <div class="progress w-75 mb-4" style="height: 4px">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: 65%" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <a href="<?php echo admin_url("admin.php?page=worksuite-notice") ?>" class="btn btn-success">
                                        <?php echo esc_html("Go to notice");?>
                                    </a>
                                </div>
                                <!-- /Total Notice-->
                                ...
                                <!-- Messages -->
                                <div class="col-12 col-sm-4">
                                    <h4 class="my-2 pt-1"><?php echo esc_html("Chats")?></h4>
                                    <div class="progress w-75 mb-4" style="height: 4px">
                                        <div class="progress-bar bg-secondary" role="progressbar" style="width: 65%" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <a href="<?php echo admin_url("admin.php?page=worksuite-messages") ?>" class="btn btn-secondary"><?php echo esc_html("Open Chats")?></a>
                                </div>
                                <!-- /Messages -->

                                <!-- Total Employees -->
                                <div class="col-12 col-sm-4">
                                    <h4 class="my-2 pt-1"><?php echo esc_html("Total Employees " . $employees_total); ?></h4>
                                    <div class="progress w-75 mb-4" style="height: 4px">
                                        <div class="progress-bar bg-warning" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <a href="<?php echo admin_url("admin.php?page=worksuite-employees") ?>" class="btn btn-warning"><?php echo esc_html("Open Employees");?></a>
                                </div>
                                <!-- /Total Employees -->
                            </div>
                        </div>
                    ...
                    <form class="w-px-600 border rounded p-3 p-md-5 border border-warning alert  alert-dismissible " method="POST">
                        ...
                        <div class="card bg-warning text-white mb-3">
                            <h4 class="title mt-3 card-title text-white"> 
                                ...
                                <?php echo esc_html(", Welcome to WorkSuite"); ?> 
                            </h4>
                        </div>

                        <div class="mb-3" role="">
                            <p class="mb-0" style="text-align: justify; text-justify: inter-word;">
                                <?php echo esc_html("Unlock the full potential of project and task management with Worksuite, developed by the talented team at Cloodo. Click on \"Register\" to discover this comprehensive solution that allows you to create tasks, schedule work, manage budgets, track progress, and communicate with colleagues all in one platform. Don't miss out on this opportunity to enhance your work productivity - sign up now!");?>
                            </p>
                        </div>
                        <div class="col-12 d-flex justify-content-between">
                            <div></div>
                            <button type="submit" class="btn rounded-pill btn-warning waves-effect waves-light mt-3" name="cloodo_register">
                                <?php echo esc_html("Register")?>
                            </button>
                        </div>
