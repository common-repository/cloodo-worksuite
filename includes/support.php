...
if ($token && $token != null) {
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card-content">
            <div class="card-body mb-2 pt-5 text-primary" style="text-align: left; font-size: 40px; "><?php echo esc_html("Support service for WorkSuite")?></div>
            <div class="card-body" style="font-size: 20px;"><?php echo esc_html("Please choose service support")?></div>
        </div>
    </div>
    <!--/ Welcome support -->
                        ...
                        <div class="col-md-6 col-lg-3 mb-3">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo esc_url("https://cloodo.com/service/".$alias) ?>" class="btn btn-outline-primary" target="_blank"><?php echo esc_html("Get suppor")?></a>
                                </div>
                            </div>
                        </div>
                        <!-- Support -->
