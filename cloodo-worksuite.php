...
$admin_menus = [
    ...
    'worksuite-work' => [
        ...
        'target_url' => 'https://worksuite.cloodo.com/apps/work/all-projects?tokenws=' . $token,
        'token_require' => true,
        'page_title' => 'Work',
        'menu_title' => 'Work',
        'capability' => 'manage_options',
    ...
    'worksuite-leads' => [
        'parent_slug' => 'worksuite',
        'target_url' => 'https://worksuite.cloodo.com/apps/all-leads?tokenws=' . $token,
        'token_require' => true,
        'page_title' => 'Leads',
        'menu_title' => 'Leads',
        'capability' => 'manage_options',
    ...
    'worksuite-products' => [
        'parent_slug' => 'worksuite',
        'target_url' => 'https://worksuite.cloodo.com/apps/settings/all-products?tokenws=' . $token,
        'token_require' => true,
        'page_title' => 'Products',
        'menu_title' => 'Products',
        'capability' => 'manage_options',
    ...
    'worksuite-employees' => [
        'parent_slug' => 'worksuite',
        'target_url' => 'https://worksuite.cloodo.com/apps/hr/all-employees?tokenws=' . $token,
        'token_require' => true,
